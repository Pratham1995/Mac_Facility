		...
		if (action.equalsIgnoreCase("searchspecificMar") ) {  
			...
			if (id!=null) {
				...
				Mform1.setMARDetails(Mform1_list.get(Mform1Index).getFacilityType(), Mform1_list.get(Mform1Index).getFacilityName(), 
						Mform1_list.get(Mform1Index).getDescription(), Mform1_list.get(Mform1Index).getReportedBy(), Mform1_list.get(Mform1Index).getDate(), Mform1_list.get(Mform1Index).getTime(), Mform1_list.get(Mform1Index).getMar());
