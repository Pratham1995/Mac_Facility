...
<table>
  <tr>
   <td>
    ...
    <tr>
    <td> Facility ID (*): </td>
  <td> <input name="idfacility" value="<c:out value='${facility.idfacility}'/>" type="text" maxlength="16"> </td>
    ...
    <td> Facility Name (*): </td>
     ...
     <td> <input name="facility_name" value="<c:out value='${facility.facility_name}'/>" type="text" maxlength="16"> </td>
