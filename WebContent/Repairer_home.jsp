...
<!-- TO MAKE THE URL REFERENCES WORK YOU MUST HAVE SESSION ID DISABLED IN URL - SEE WEB.XML -->
      ...
      <div class="logo"><h1><a href="<c:url value='/' />"> Repairer Home</a></h1></div>
      
      <form action="/Mac_Facility/RepairerController" method="get">
	  <input type="submit" class="btn btn-primary col-md-3" role="button" value="View My Assigned Repairs">
  ...
  <div class="content">
       ...
       <table border="1" class="myTable"> 
			<tr class="myTableRow"> 
				<th class="myTableHead" style="padding-right: 10px; text-align: center">ID</th> 
			...
			<c:forEach items="${repairerList}" var="mar" varStatus="status">
				<tr>
		 	<td><a href="/Mac_Facility/viewRepairerDetails.jsp?userId=${mar.id}"><div style="height:100%;width:100%"><c:out value="${mar.id}" /></div></a></td>
 ...
 <br><br>
<br>
<a href="RequestReservation.jsp">Request Reservation</a>
